...
image_dir=/data5/shetw/HMDB51/extracted_frames
...
meta_dir=/home/chengxuz/video_unsup/build_data/HMDB51
# Your gpu number
gpu=0

main_setting=vd_finetune_HMDB_fx.vd_3dresnet_sc # Table 2 result
#main_setting=vd_finetune_HMDB_fx.vd_3dresnet_cj # Table 3 result
