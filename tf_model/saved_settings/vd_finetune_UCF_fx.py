...
def finetune_UCF_all_basics(args):
...
def vd_ctl_sc():
    args = {}
    args = finetune_UCF_all_basics(args)
    args = single_frame_setting(args)

    args['train_prep'] = 'MultiScaleCrop_224'
    args["save_exp"] = "vd_finetune/UCF/vd_ctl_sc_2"
    args["lr_boundaries"] = '1390000,1410000'
    return args
...
def vd_ctl_cj():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_ctl_cj"
...
def vd_sup_ctl_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_sup_ctl_sc"
    args['train_prep'] = 'MultiScaleCrop_224'
...
def vd_sup_ctl_cj():
    ...
    args = single_frame_setting(args)    
    args['load_exp'] = "vd_sup/ctl/vd_f1_ctl"
    args["save_exp"] = "vd_finetune/UCF/vd_sup_ctl_cj"
    args['train_prep'] = 'ColorJitter'
    args["lr_boundaries"] = '715000,735000'
    return args
...
def vd_slowfast_a4_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_slowfast_sc"
    args['train_prep'] = 'MultiScaleCrop_224' 
    args["lr_boundaries"] = '1360000,1370000'
    return args
...
def vd_slowfast_a4_cj():
    ...
    args = finetune_UCF_all_basics(args)
    args = slowfast_setting(args)
    args["save_exp"] = "vd_finetune/UCF/vd_slowfast_cj"
    args['train_prep'] = 'ColorJitter'
    args["lr_boundaries"] = '1360000,1370000'
    return args
...
def vd_sup_slowfast_a4_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_sup_slowfast_sc"
    args['train_prep'] = 'MultiScaleCrop_224'  
...
def vd_sup_slowfast_a4_cj():
    ...
    args = slowfast_setting(args)
    args['load_exp'] = "vd_sup/ctl/vd_sup_slowfast_a4"
    args["save_exp"] = "vd_finetune/UCF/vd_sup_slowfast_cj"
    args['train_prep'] = 'ColorJitter'
    args["lr_boundaries"] = '345000'
    return args
...
def vd_slowfast_single_a4_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_slowfast_single_sc_2"
    args['train_prep'] = 'MultiScaleCrop_224' 
...
def vd_slowfast_single_a4_cj():
    ...
    args = finetune_UCF_all_basics(args)
    args = slowfast_single_setting(args)
    args["save_exp"] = "vd_finetune/UCF/vd_slowfast_single_cj_2"
    args['train_prep'] = 'ColorJitter'
    args["lr_boundaries"] = '10000,20000'
    return args
...
def vd_3dresnet_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_3dresnet_sc"
...
def vd_3dresnet_cj():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_3dresnet_cj"
...
def vd_sup_3dresnet_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_sup_3dresnet_sc"
    args['train_prep'] = 'MultiScaleCrop_112'
    return args
...
def vd_sup_3dresnet_cj():
    ...
    args['load_exp'] = 'vd_sup/KN/vd_sup_3dresnet'
    args["save_exp"] = "vd_finetune/UCF/vd_sup_3dresnet_cj"
    args['train_prep'] = 'ColorJitter_112'  
    return args
...
def vd_opn_sc():
    ...
    args["save_exp"] = "vd_finetune/UCF/vd_opn_sc"
    args['train_prep'] = 'MultiScaleCrop_224'  
...
def vd_3drotnet_UCF():
    ...
    args['load_port'] = 27006
    args["save_exp"] = "vd_finetune/UCF/vd_3drotnet_hflip"
